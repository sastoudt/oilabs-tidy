...
$\hat{p}$ changes as $n$ and $p$ changes. It is not crucial that you understand the innerworkings of the function. Just read the documentation (header in comments describing how to use the function) noting the inputs and outputs.
