...
We'll grab the parts we need, and adjust the parts we want to change. It is common practice to build off of pre-existing code when we developm new functions. It is not crucial that you understand every line of this chunk; just focus on the resulting plot. 
